...
app.get('/image.png', async (req, res) => {
  try {
    // Replace these with the actual URLs of your 4 different images
    const imageSources = [
    ...
    const resultImage = await sharp({
      ...
      .composite([
        ...
        { input: images[1], top: 0, left: 202 },
        { input: images[2], top: 202, left: 0 },
        { input: images[3], top: 202, left: 202 },
      ])
      .png()
      .toBuffer();

    // Save the result image locally (optional)
